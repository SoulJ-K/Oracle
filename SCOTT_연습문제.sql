...
SELECT *
FROM EMP
--WHERE EXTRACT (YEAR FROM TO_DATE(190516, 'YYMMDD')) - EXTRACT(YEAR FROM HIREDATE) >= 38;    
--WHERE EXTRACT (YEAR FROM SYSDATE) - EXTRACT(YEAR FROM HIREDATE) >= 38;    
--WHERE EXTRACT (YEAR FROM(SYSDATE - TO_DATE(HIREDATE,'YYYYMMDD')) >= 38;
WHERE MONTHS_BETWEEN(TO_DATE(190516, 'YYMMDD'), HIREDATE)/12 >= 38;
--WHERE MONTHS_BETWEEN ('20190516' , HIREDATE) /12 >= 38;
